exports.expenseAddedTemplate = (expenseName, owner) => `<!DOCTYPE html>
                  ...
                  <td>
                    <table
                      ...
                      style="
                        ...
                        border-bottom: 0 solid #fa1313;
                        border-left: 0 solid #fa1313;
                        border-radius: 0;
                        border-right: 0px solid #fa1313;
                        border-top: 0 solid #fa1313;
                        color: #000000;
                        width: 570px;
                        margin: 0 auto;
                      "
                            ...
                            >
                              <tr>
                                ...
                                >
                                  ...
                                  >
                                    <p style="margin: 0">
                                      You have been added to new expense
                                      <strong>${expenseName}</strong> by
                                      <strong>${owner}</strong>. Clear the bill
                                      and attach the screenshot to get the
                                      approval.
                                    </p>
                                  </div>
                                </td>
                            ...
                            >
                              <tr>
                                <td class="pad">
                                  ...
                                  >
                                    <p style="margin: 0">
                                      Copyright © 2023 MeroPay, All rights
                                      reserved.
                                    </p>
                                  </div>
                                </td>
